...
class _AppInitializerState extends ConsumerState<AppInitializer> {
  late final Future<void> _initializationSequence;

  @override
  void initState() {
    super.initState();
    // PERFORMANCE: Memoize the initialization future to prevent redundant calls during rebuilds
    _initializationSequence = Future.wait([
      widget.initFuture,
